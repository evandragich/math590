...
&= \int_{0}^{t}0.025(s)ds\text{ , 0 < t < 2} \\
&\hphantom{=}\int_{0}^{2}0.025(s)ds+ \int_{2}^{t}0.05ds\text{  , t > 2} \\
&= 0.0125t^{2}\text{ , 0 < t < 2} \\
&\hphantom{=}0.05+ 0.05t-0.1\text{, t > 2} \\
&= 0.0125t^{2}\text{ , 0 < t < 2} \\
&\hphantom{=}-0.05+ 0.05t\text{, t > 2} \\
\end{aligned}
$$

Thus, to solve for points where $0 < t < 2$, we must equate 
...
To solve for points where $t > 2$, we must equate 

$$
\begin{aligned}
0.05t^2 &= -0.05 + 0.05t \\
0.05t^2 -0.05t + 0.05 &= 0 \\
0.05(t^{2} - 1 + 1) \\
\end{aligned}
$$