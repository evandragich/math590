...
&= 0.0198 \\
AV(750\ax{\angl{8}{1.98\%}}) &= 750\sum_{k = 0}^{3}(1.08198)^k \\
&= 750(8.57691) \\
&= \$ 6432.68
\end{aligned}
$$
...
$Rate(28, -1, 18, 0, 0) = 3.343\%$

### d

$Rate(28, -1, 18, 0, 1) = 3.645\%$
...
Thus, for $k = 1$, $\sx{\angl{kn}} = 1$, and for $k \geq 2$, $\sx{\angl{kn}} =x((\frac{y}{x} - 1)^{k - 1} + 1)$
