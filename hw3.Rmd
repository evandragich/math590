...
We begin by substituting $\mu_{x + s}^{*} = 2 \mu_{x + s}$ into our expression. From there, we can extract the factor of 2 and rearrange to where the exponentiated term is itself raised to the power of 2. From there, the definiton of $\mu_{x + s}$ follows and we see that the linear doubling of the force of mortality translates into a quadratic squaring of the survival function.